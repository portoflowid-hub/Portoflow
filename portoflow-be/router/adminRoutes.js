...
// Course routes
router.get('/api/admin/courses', ...adminAccess, getAllCourses)
router.post('/api/admin/courses', ...adminAccess, createCourse)
router.put('/api/admin/courses/:id', ...adminAccess, updateCourse)
router.delete('/api/admin/courses/:id', ...adminAccess, deleteCourse)
